# copyright@https://github.com/dendenxu/longvolcap/blob/101c00b/easyvolcap/utils/base_utils.py
from __future__ import annotations
from copy import copy
from typing import Dict, List, Union, Mapping, TypeVar, Callable, Iterable
